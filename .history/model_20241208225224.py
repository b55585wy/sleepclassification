...
class SingleSalientModel(models.Model):
    ...
    def __init__(self, **params):
        ...
        self.sleep_epoch_len = params['sleep_epoch_len']
        self.sequence_length = params['preprocess']['sequence_epochs']
        self.filters = params['train']['filters']
        self.kernel_size = params['train']['kernel_size']
        self.pooling_sizes = params['train']['pooling_sizes']
        self.activation = params['train']['activation']
        self.u_depths = params['train']['u_depths']
        self.u_inner_filter = params['train']['u_inner_filter']
        self.mse_filters = params['train']['mse_filters']
